...
function Nav() {
  ...
  return (
    <nav style={{
      ...
      background: sc ? "rgba(7,9,13,0.95)" : "transparent",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          {["Services", "About", "FAQ", "Contact"].map(l => (
            <a key={l} href={l==="Services"?"/services":l==="About"?"/about":l==="FAQ"?"/blog":"/contact"} style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: 13, fontWeight: 550 }}>{l}</a>
          ))}
      ...
      <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "120px 24px 70px" }}>
          ...
          <div>
            <Fade>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(43,127,255,0.08)", border: "1px solid rgba(43,127,255,0.15)", borderRadius: 50, padding: "5px 14px 5px 10px", marginBottom: 22 }}>
                ...
                <span style={{ color: B2, fontSize: 11, fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase" }}>The #1 laundromat marketing agency</span>
              </div>
            </Fade>
            <Fade delay={.05}>
            ...
            <Fade delay={.1}>
              <p style={{ fontSize: 16, color: "rgba(255,255,255,0.5)", maxWidth: 460, lineHeight: 1.65, marginBottom: 28 }}>
                We help laundromats across the U.S. grow with geo-fenced ads, AI-powered tools, email & SMS marketing, commercial outreach, and more — all managed for you.
              </p>
            </Fade>
            <Fade delay={.15}>
        ...
        <Fade delay={.25}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 1, marginTop: 50, background: "rgba(255,255,255,0.06)", borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.06)" }}>
            {[["125+","Laundromats"],["20+","Years exp."],["3x","Avg. ROI"],["24/7","AI support"]].map(([n,l],i) => (
...
const SVC = [
  ...
  ["🤖","AI Chatbot & Voice Bot","24/7 support","Custom AI chatbot on your website and social plus an AI voice agent answering calls — capturing leads, booking appointments, and handling questions around the clock."],
  ...
  ["⭐","Google Reviews","Reputation","Systematic review generation via automated SMS requests. Higher review counts mean higher Maps rankings — more walk-ins without extra ad spend."],
];
...
function Process() {
  const steps = [["01","Discovery Call","Learn about your goals — no sales pitch."],["02","Custom Strategy","Plan based on your location and competition."],["03","Launch & Optimize","Campaigns go live. We optimize on real data."],["04","Report & Scale","Clear reports. We scale what works."]];
  return (
  ...
  return (
    <section style={{ background: BG2, padding: "90px 0", overflow: "hidden" }}>
      ...
      <div onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)} style={{ overflow: "hidden" }}>
        <div style={{ display: "flex", gap: 16, animation: "scroll 40s linear infinite", animationPlayState: paused ? "paused" : "running", width: "max-content" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 48, alignItems: "center" }}>
        <Fade>
          <div>
            ...
            <h2 style={{ fontSize: "clamp(26px,3.5vw,36px)", fontWeight: 800, color: "#fff", marginBottom: 14, lineHeight: 1.15 }}>20+ years of marketing expertise, 100% focused on laundromats</h2>
            <p style={{ fontSize: 15, color: "rgba(255,255,255,0.5)", lineHeight: 1.7, marginBottom: 12 }}>We built Fresh Leads to serve one industry better than anyone. Every strategy and AI tool is purpose-built for the laundry business.</p>
            <p style={{ fontSize: 15, color: "rgba(255,255,255,0.5)", lineHeight: 1.7, marginBottom: 22 }}>No guesswork, no generic playbooks — just proven systems that drive real results for laundromat owners nationwide.</p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              {["Full-service agency","Laundromat specialists","AI-powered tools","Proven ROI"].map((t,i) => (
          ...
          <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "32px 28px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "rgba(255,255,255,0.3)" }}>Serving laundromats across the United States</div>
              </div>
            </div>
            <div style={{ background: "rgba(43,127,255,0.04)", border: "1px solid rgba(43,127,255,0.08)", borderRadius: 10, padding: "16px 18px", marginBottom: 20 }}>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", lineHeight: 1.6, margin: 0 }}>Island-born creativity meets data-driven strategy. Genuine care, personal attention, and a commitment to your success.</p>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, textAlign: "center" }}>
              {[["125+","Clients"],["48","States"],["100%","Laundromat focus"]].map(([n,l],i) => (
                <div key={i}>
    ...
    <div style={{ fontFamily: "'DM Sans', -apple-system, sans-serif", background: BG, minHeight: "100vh" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        ::selection{background:rgba(43,127,255,0.2)}
