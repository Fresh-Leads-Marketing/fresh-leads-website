      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(7,9,13,0.92)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
          ...
          <div className="dn" style={{ display: "flex", alignItems: "center", gap: 24 }}>
            ...
            {["About", "Pricing", "Blog", "FAQ", "Contact"].map(l => <a key={l} href={l==="About"?"/about":l==="Pricing"?"/pricing":l==="Blog"?"/blog":l==="FAQ"?"/faq":"/contact"} style={{ color: l === "Services" ? "#fff" : "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: 13, fontWeight: l === "Services" ? 650 : 550 }}>{l}</a>)}
...
const SVC = [
  ...
  { icon: "🤖", t: "AI Chatbot & Voice Bot", s: "24/7 automated support", desc: "Your website and phone become lead-capturing machines. The AI chatbot handles website visitors, Facebook messages, and Instagram DMs. It answers questions, shares hours and pricing, and captures lead information. The voice bot picks up your phone calls, handles FAQs, and sounds completely natural. Both are trained specifically on your laundromat's services and information.", q: "Will it sound robotic or weird to my customers?", a: "Not at all. We custom-train both bots on your specific business. The voice bot sounds like a friendly receptionist, and the chatbot feels like texting with a helpful staff member.", graphic: <AIGraphic /> },
