...
function Features() {
  return (<section style={{ background: BG, padding: "80px 24px" }}><div style={{ maxWidth: 900, margin: "0 auto" }}><FI><h2 style={{ fontSize: "clamp(24px,3vw,34px)", fontWeight: 800, color: "#fff", marginBottom: 14, textAlign: "center" }}>Two AI tools, one goal: never miss a lead</h2></FI><div className="fg" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}><FI><div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "28px 24px" }}><h3 style={{ fontSize: 18, fontWeight: 800, color: "#fff", marginBottom: 14 }}>💬 AI Chatbot</h3>{["Website, Facebook, Instagram, Google","Answers hours, pricing, services","Captures leads into your CRM","Directs customers to contact you","Custom-trained on your business","Handles 80%+ of inquiries automatically"].map((item,i)=><div key={i} style={{display:"flex",gap:8,marginBottom:10}}><span style={{color:B,flexShrink:0,fontSize:12,marginTop:2}}>→</span><span style={{fontSize:13.5,color:"rgba(255,255,255,0.5)",lineHeight:1.5}}>{item}</span></div>)}</div></FI><FI delay={0.08}><div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "28px 24px" }}><h3 style={{ fontSize: 18, fontWeight: 800, color: "#fff", marginBottom: 14 }}>📞 AI Voice Bot</h3>{["Answers calls 24/7 naturally","Qualifies and captures contact info","Answers FAQs and pricing questions","Directs callers to your team when needed","Transfers when human needed","Full transcripts in dashboard"].map((item,i)=><div key={i} style={{display:"flex",gap:8,marginBottom:10}}><span style={{color:B,flexShrink:0,fontSize:12,marginTop:2}}>→</span><span style={{fontSize:13.5,color:"rgba(255,255,255,0.5)",lineHeight:1.5}}>{item}</span></div>)}</div></FI></div></div></section>);
}
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <FI>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.5)", maxWidth: 600, margin: "0 auto", lineHeight: 1.65 }}>Experience our AI tools firsthand. Call our AI Voice Bot or chat with our AI assistant below to see exactly how this technology works for your business.</p>
          </div>
        </FI>
        <div className="try-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
          <FI>
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "32px 28px", height: "100%", display: "flex", flexDirection: "column" }}>
              ...
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.5)", lineHeight: 1.65, marginBottom: 20, flex: 1 }}>Call our Fresh Leads Marketing AI Voice Bot. Ask about our services, pricing, how onboarding works, or anything else — and hear how natural it sounds. This is the same technology we set up for your laundromat.</p>
