...
function CaseStudy(){return(<section style={{background:BG2,padding:"70px 24px"}}><div style={{maxWidth:900,margin:"0 auto"}}><FI><p style={{color:B,fontWeight:700,fontSize:13,letterSpacing:".07em",textTransform:"uppercase",marginBottom:24,textAlign:"center"}}>Why CRM matters</p></FI><div className="csg detail-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr",gap:16}}><FI><div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:16,padding:"28px 26px"}}><h3 style={{fontSize:17,fontWeight:700,color:"#fff",marginBottom:12}}>Centralize your data</h3><p style={{fontSize:15,color:"rgba(255,255,255,0.6)",lineHeight:1.65,marginBottom:16}}>Stop switching between your POS, email, phone system, and spreadsheets. Our CRM pulls everything into one dashboard so you can see every customer interaction in one place.</p></div></FI><FI delay={0.08}><div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:16,padding:"28px 26px"}}><h3 style={{fontSize:17,fontWeight:700,color:"#fff",marginBottom:12}}>Automate follow-ups</h3><p style={{fontSize:15,color:"rgba(255,255,255,0.6)",lineHeight:1.65,marginBottom:16}}>Auto-tag customers by behavior, trigger re-engagement campaigns for lapsed visitors, and track every touchpoint from first visit to lifetime loyalty.</p></div></FI></div></div></section>)}
...
export default function Page(){return(<div style={{fontFamily:"'DM Sans', -apple-system, sans-serif",background:BG,minHeight:"100vh"}}><Nav/><Hero/><CaseStudy/><Objections/><FAQ/><CTA/><Footer/></div>)}
