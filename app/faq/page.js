          ...
          {CATEGORIES.map((cat, i) => (
            <FI key={i} delay={i * 0.04}>
              <a href={`#cat-${i}`} style={{
                ...
                transition: "all .2s"
              }} onMouseEnter={e => { e.target.style.borderColor = "rgba(43,127,255,0.3)"; e.target.style.color = "#fff"; }} onMouseLeave={e => { e.target.style.borderColor = "rgba(255,255,255,0.08)"; e.target.style.color = "rgba(255,255,255,0.75)"; }}>
